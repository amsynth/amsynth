...
public:
	...
	const std::vector<std::string> & parameterValueStrings() const { return _parameterValueStrings; }
	
	void setParameterValueStrings(const char **names, size_t count);
...
private:
	...
	std::vector<std::string>		_parameterValueStrings;
};
